...
import { MM1NFormCalculator } from './form'
import { MM1NResultCalculator } from './results'
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MM1NFormCalculator onCalculate={handleCalculate} />
          </div>

          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MM1NResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
