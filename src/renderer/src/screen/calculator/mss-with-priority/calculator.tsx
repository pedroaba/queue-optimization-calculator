...
import { MSSWithPriorityFormCalculator } from './form'
import { MSSWithPriorityResultCalculator } from './results'
import type { Results } from '@renderer/lib/models/mss-with-priority'
import { useNavigate } from 'react-router-dom'

export function MSSWithPriorityCalculator() {
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MSSWithPriorityFormCalculator onCalculate={handleCalculate} />
          </div>

          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MSSWithPriorityResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
