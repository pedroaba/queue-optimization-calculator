...
import { MMSGreaterThanOneKFormCalculator } from './form'
import { MMSGreaterThanOneKResultCalculator } from './results'
import type { Results } from '@renderer/lib/models/mms-greater-than-1-k'
import { useNavigate } from 'react-router-dom'

export function MMSGreaterThanOneKCalculator() {
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MMSGreaterThanOneKFormCalculator onCalculate={handleCalculate} />
          </div>

          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MMSGreaterThanOneKResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
