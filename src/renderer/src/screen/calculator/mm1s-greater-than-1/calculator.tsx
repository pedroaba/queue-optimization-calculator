...
import { MMSGreaterThanOneFormCalculator } from './form'
import { MMSGreaterThanOneResultCalculator } from './results'
import type { Results } from '@renderer/lib/models/mms-greater-than-1'
import { useNavigate } from 'react-router-dom'

export function MMSGreaterThanOneCalculator() {
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MMSGreaterThanOneFormCalculator onCalculate={handleCalculate} />
          </div>

          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MMSGreaterThanOneResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
