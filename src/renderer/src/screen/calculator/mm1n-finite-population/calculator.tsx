...
import { MM1NFinitePopulationFormCalculator } from './form'
import { MM1NFinitePopulationResultCalculator } from './results'
import type { Results } from '@renderer/lib/models/mm1n-finite-population'
import { useNavigate } from 'react-router-dom'

export function MM1NFinitePopulationCalculator() {
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MM1NFinitePopulationFormCalculator onCalculate={handleCalculate} />
          </div>

          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MM1NFinitePopulationResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
