...
import { MSSNonPreemptivePriorityFormCalculator } from './form'
import { MSSNonPreemptivePriorityResultCalculator } from './results'
import type { Results } from '@renderer/lib/models/mss-non-preemptive-priority'
import { useNavigate } from 'react-router-dom'

export function MSSNonPreemptivePriorityCalculator() {
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-4xl">
        ...
        <div className="flex items-center mb-8 p-4 bg-slate-800/50 rounded-xl backdrop-blur-sm border border-slate-700/50">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Modelo M/S/S com Prioridade, não preemptivo
            </h1>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MSSNonPreemptivePriorityFormCalculator
          ...
          {/* Results Section */}
          <div className="bg-slate-800/60 rounded-xl p-6 backdrop-blur-sm border border-slate-700/50 shadow-xl">
            <MSSNonPreemptivePriorityResultCalculator results={results} />
          </div>
        </div>
      </div>
    </div>
