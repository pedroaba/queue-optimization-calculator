...
import {
  mssNonPreemptivePriority,
  type Results,
} from '@renderer/lib/models/mss-non-preemptive-priority'
...
export function MSSNonPreemptivePriorityFormCalculator({
  onCalculate,
}: FormProps) {
  ...
  const handleCalculate = () => {
    ...
    try {
      const results = mssNonPreemptivePriority({
